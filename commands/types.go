...
const (
	...
	// list objects params
	ListObjectParamID           ListObjectParam = 0x01
	ListObjectParamType         ListObjectParam = 0x02
	ListObjectParamDomains      ListObjectParam = 0x03
	ListObjectParamCapabilities ListObjectParam = 0x04
	ListObjectParamAlgorithm    ListObjectParam = 0x05
	ListObjectParamLabel        ListObjectParam = 0x06
)
